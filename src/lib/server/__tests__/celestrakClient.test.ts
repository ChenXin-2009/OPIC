  ...
  describe('TLE验证', () => {
    it('应该验证有效的TLE数据', () => {
      const validTLE = {
        ...
        line2: '2 25544  51.6400 208.9163 0006317  69.9862  25.2906 15.50030900000001'
      };
    ...
    it('应该拒绝长度不正确的TLE行', () => {
      const invalidTLE = {
        name: 'TEST',
        line1: '1 25544U 98067A   24001.50000000  .00016717  00000-0  10270-3 0  900',
        line2: '2 25544  51.6400 208.9163 0006317  69.9862  25.2906 15.5003090000000'
      };
    ...
    it('应该拒绝不以"1 "开头的第一行', () => {
      const invalidTLE = {
        name: 'TEST',
        line1: '2 25544U 98067A   24001.50000000  .00016717  00000-0  10270-3 0  9009',
        line2: '2 25544  51.6400 208.9163 0006317  69.9862  25.2906 15.50030900000001'
      };
    ...
    it('应该拒绝不以"2 "开头的第二行', () => {
      const invalidTLE = {
        name: 'TEST',
        line1: '1 25544U 98067A   24001.50000000  .00016717  00000-0  10270-3 0  9009',
        line2: '1 25544  51.6400 208.9163 0006317  69.9862  25.2906 15.50030900000001'
      };
...
2 25544  51.6400 208.9163 0006317  69.9862  25.2906 15.50030900000001`;
...
1 00001U 00000A   24001.50000000  .00000000  00000-0  00000-0 0  9993
2 00001  00.0000 000.0000 0000000 000.0000 000.0000 01.00000000000004
SATELLITE 2
1 00002U 00000B   24001.50000000  .00000000  00000-0  00000-0 0  9994
2 00002  00.0000 000.0000 0000000 000.0000 000.0000 01.00000000000005`;
