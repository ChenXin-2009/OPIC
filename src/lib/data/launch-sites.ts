...
export const LAUNCH_SITES: LaunchSite[] = [
  {
    id: 'cape-canaveral',
    name: 'Cape Canaveral (卡纳维拉尔角)',
    country: '美国',
    lat: 28.3922,
    lon: -80.6077,
    altitude: 3,
    type: 'orbital',
    desc: 'NASA / Space Force 东靶场，肯尼迪航天中心所在地',
  },
  {
    id: 'baikonur',
    name: 'Baikonur (拜科努尔)',
  ...
  },
  {
    ...
    altitude: 12,
    type: 'orbital',
    desc: 'ESA 圭亚那航天中心，靠近赤道利于地球同步轨道发射',
  },
  {
    id: 'jiuquan',
    name: 'Jiuquan (酒泉)',
  ...
  },
  {
    ...
    altitude: 1800,
    type: 'orbital',
    desc: '中国地球同步轨道发射的主要基地',
  },
  {
    id: 'tanegashima',
    name: 'Tanegashima (种子岛)',
    country: '日本',
    lat: 30.4000,
    lon: 130.9683,
    altitude: 30,
  ...
  {
    id: 'sriharikota',
    name: 'Sriharikota (斯里赫里戈达)',
    country: '印度',
    lat: 13.7199,
    lon: 80.2304,
    altitude: 5,
    type: 'orbital',
    desc: 'ISRO 萨蒂什·达万航天中心',
  },
  {
    id: 'vandenberg',
    name: 'Vandenberg (范登堡)',
